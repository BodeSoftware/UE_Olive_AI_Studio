 ...
 * OpenRouter Provider
 *
 * AI provider client for OpenRouter (https://openrouter.ai/).
 * Supports streaming responses and tool calling via OpenAI-compatible API.
 */
...
private:
	...
	static const FString OpenRouterApiUrl;
