...
void FOliveMCPPromptTemplates::RegisterDefaultTemplates()
{
	...
	// ==========================================
	{
		...
		Template.TemplateText =
			...
			TEXT("1. Search the project for related assets: project.search with keywords from the task. ")
			...
			TEXT("4. When building, compile after completing each function's graph logic. ")
			TEXT("Fix the first compile error before writing more logic.\n\n")
			TEXT("5. When done, verify your work compiles cleanly and contains the logic you intended. ")
	...
	// ==========================================
	{
		...
		Template.TemplateText =
			...
			TEXT("ORIENT: Search the project for existing assets that relate to this feature (project.search). ")
			...
			TEXT("STRUCTURE: Create the Blueprint if it does not exist (blueprint.create). ")
			TEXT("Add components and variables that the feature needs. ")
			...
			TEXT("BUILD: Write graph logic using whichever approach fits the task. ")
			...
			TEXT("VERIFY: Compile after completing each function's logic (blueprint.compile). ")
