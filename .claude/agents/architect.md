...
1. Before designing anything, READ the existing codebase thoroughly using Glob and Grep
...
6. After producing a design, summarize what the coder needs to know to start implementation

## Memory

As you work, update your agent memory with:
- Architectural decisions made and their rationale
- Module interfaces that have been finalized
- Cross-cutting concerns discovered
- Patterns established that should be consistent across modules
- Technical debt identified for later resolution
